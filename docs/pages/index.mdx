...
<div className="absolute w-full top-0 bottom-0 bg-[url('/colosseum-light.svg')] dark:bg-[url('/modified_pattern.svg')] opacity-30 max-sm:w-[200%] max-sm:-left-[200px] max-sm:hidden">
