...
<div className="fixed w-full top-0 left-0 h-full min-h-screen bg-[url('/colosseum-light.svg')] dark:bg-[url('/modified_pattern.svg')] opacity-30 max-sm:w-[200%] max-sm:-left-[200px] max-sm:hidden">
...
Check out <a href={"/docs/getting-started"}>Getting Started</a> for more details.
